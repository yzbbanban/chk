...
contract ConfluxRewardCard is ERC1155 {
    ...
    address owner;
    // Contract name
    string public name="Conflux Reward Card";
    // Contract symbol
    string public symbol="CFXR CARD";
    ...
    constructor() public ERC1155("http://nft.yzbbanban.com:18756/v1/nft/reward/") {
        owner=msg.sender;
        baseUri = "http://nft.yzbbanban.com:18756/v1/nft/reward/";
    ...
    function mint(address _to) public onlyMiner() returns(uint256){
        _tokenIds.increment();
        uint256 newItemId = _tokenIds.current();
        _mint(_to, newItemId, 1, bytes(Strings.strConcat(baseUri, Strings.fromAddress(address(this)), "/"))); 
